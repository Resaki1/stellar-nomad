...
const SimGroup = ({ space, positionKm, children }: SimGroupProps) => {
  ...
  // Run after simulation updates (e.g., floating-origin recenter) so we use the
  // latest world origin within the same frame, avoiding a one-frame hitch when
  // the origin recenters.
  useFrame(() => {
